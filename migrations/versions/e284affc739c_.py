...
Revision ID: e284affc739c
Revises: 
Create Date: 2021-07-23 16:40:44.695392
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('available', 'reserved', 'canceled', 'confirmed', 'missed', name='reservation_status'), nullable=False),
